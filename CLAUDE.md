...
- **V3.1 status**: Complete (M30–M34 + audit fixes). Casting armour (armor OnHitScripts), 47 enchantments, CombatScript/CreatureType enums, armor zone selection, OmegaAttack prerequisites. 2756 tests.
